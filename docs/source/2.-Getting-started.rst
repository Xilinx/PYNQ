...
**pynq** is the default Ubuntu hostname of the board. You can change this in the Ubuntu settings if necessary. (This is only recommneded where more than one board will be used on the same network. e.g. classroom teaching.) 
