...
module switch_bit(
    ...
    reg [13:0] tri_i_out_demux;
    assign {ss_i_in,mosi_i_in,miso_i_in,spick_i_in,sda_i_in,scl_i_in,tri_i_in} = tri_i_out_demux;

    always @(gpio_sel, tri_o_in, scl_o_in, sda_o_in, spick_o_in, miso_o_in, mosi_o_in, ss_o_in)
       case (gpio_sel)
    ...
    always @(gpio_sel, tri_t_in, scl_t_in, sda_t_in, spick_t_in, miso_t_in, mosi_t_in, ss_t_in)
       case (gpio_sel)
