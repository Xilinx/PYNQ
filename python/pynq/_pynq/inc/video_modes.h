...
typedef struct {
    ...
    u32 hps; /*Start time of Horizontal sync pulse, in pixel clocks */
    u32 hpe; /*End time of Horizontal sync pulse, in pixel clocks */
    u32 hmax; /*Total number of pixel clocks per line */
    u32 hpol; /*hsync pulse polarity*/
    u32 vps; /*Start time of Vertical sync pulse, in lines */
    u32 vpe; /*End time of Vertical sync pulse, in lines */
    u32 vmax; /*Total number of lines per frame */
