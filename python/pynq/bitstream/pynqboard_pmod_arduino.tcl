...
#    create_project pynq_pmod -part xc7z020clg400-1

# CHECKING IF PROJECT EXISTS
if { [get_projects -quiet] eq "" } {
   create_project pmod_arduino . -part xc7z020clg400-1
}
...
make_wrapper -files [get_files ./pmod_arduino.srcs/sources_1/bd/system/system.bd] -top

# generate toplevel wrapper files
add_files -norecurse ./pmod_arduino.srcs/sources_1/bd/system/hdl/system_wrapper.v
...
file mkdir ./pmod_arduino.sdk
write_hwdef -force  -file ./pmod_arduino.sdk/pmod_arduino.hdf
file copy -force ./pmod_arduino.sdk/pmod_arduino.hdf ../../sdk/

# move and rename bitstream to final location
file copy -force ./pmod_arduino.runs/impl_1/top.bit ../../../python/pynq/bitstream/pynqboard_pmod_arduino.bit
