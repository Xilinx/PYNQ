proc create_ipi_design { offsetfile design_name } {
	...
	# Create instance: d_axi_pdm_0, and set properties
	set d_axi_pdm_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:d_axi_pdm:1.2 d_axi_pdm_0]
	...
	connect_bd_intf_net [get_bd_intf_pins master_0/M_AXI_LITE] [get_bd_intf_pins d_axi_pdm_0/S_AXI]

	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins master_0/M_AXI_LITE_ACLK] [get_bd_pins d_axi_pdm_0/S_AXI_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins master_0/M_AXI_LITE_ARESETN] [get_bd_pins d_axi_pdm_0/S_AXI_ARESETN]
	...
	set offset_file "${bd_path}/d_axi_pdm_v1_2_tb_include.vh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef d_axi_pdm_v1_2_tb_include_vh_"
	puts $fp "`define d_axi_pdm_v1_2_tb_include_vh_\n"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:d_axi_pdm:1.2]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/d_axi_pdm_v1_2_tb.v
...
for { set i 1 } { 1 } { incr i } {
	set design_name "d_axi_pdm_v1_2_bfm_${i}"
...
remove_files -quiet -fileset sim_1 d_axi_pdm_v1_2_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top d_axi_pdm_v1_2_tb [get_filesets sim_1]
