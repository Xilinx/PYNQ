...
// Module Name: pg_controller
// Project Name: PYNQ
//////////////////////////////////////////////////////////////////////////////////

module pg_controller #(parameter ADDR_WIDTH = 18)(
    input clk,
    ...
    pulse_gen sync_start(.async_in(gpio_control[0]&gpio_control[3]), .sync_clk(clk), .pulsed_out(start));
    pulse_gen sync_continue(.async_in(gpio_control[1]&gpio_control[3]), .sync_clk(clk), .pulsed_out(continue));
    pulse_gen sync_stop(.async_in(gpio_control[2]&gpio_control[3]), .sync_clk(clk), .pulsed_out(stop));
