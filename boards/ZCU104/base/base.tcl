...
proc create_hier_cell_phy { parentCell nameHier } {
  ...
  set_property CONFIG.C_BUF_TYPE {BUFG_GT} $dru_ibufds_gt_odiv2
  ...
  set_property CONFIG.C_BUF_TYPE {IBUFDSGTE} $gt_refclk_buf
  ...
  set_property CONFIG.CONST_VAL {1} $vcc_const0
  ...
  connect_bd_net -net net_gt_refclk_buf_IBUF_DS_ODIV2 [get_bd_pins gt_refclk_buf/IBUF_DS_ODIV2] [get_bd_pins dru_ibufds_gt_odiv2/BUFG_GT_I]
  ...
  connect_bd_net -net net_vcc_const0_dout [get_bd_pins vcc_const0/dout] [get_bd_pins dru_ibufds_gt_odiv2/BUFG_GT_CE]
  connect_bd_net -net net_vcc_const_dout [get_bd_pins TX_EN_OUT] [get_bd_pins vid_phy_controller/vid_phy_tx_axi4s_aresetn] [get_bd_pins vid_phy_controller/vid_phy_rx_axi4s_aresetn]
  connect_bd_net -net net_vid_phy_controller_irq [get_bd_pins vid_phy_controller/irq] [get_bd_pins irq2]
  connect_bd_net -net net_vid_phy_controller_phy_txn_out [get_bd_pins vid_phy_controller/phy_txn_out] [get_bd_pins HDMI_TX_DAT_N_OUT]
  connect_bd_net -net net_vid_phy_controller_phy_txp_out [get_bd_pins vid_phy_controller/phy_txp_out] [get_bd_pins HDMI_TX_DAT_P_OUT]
  connect_bd_net -net net_vid_phy_controller_rx_tmds_clk_n [get_bd_pins vid_phy_controller/rx_tmds_clk_n] [get_bd_pins RX_REFCLK_N_OUT]
  connect_bd_net -net net_vid_phy_controller_rx_tmds_clk_p [get_bd_pins vid_phy_controller/rx_tmds_clk_p] [get_bd_pins RX_REFCLK_P_OUT]
  connect_bd_net -net net_vid_phy_controller_rx_video_clk [get_bd_pins vid_phy_controller/rx_video_clk] [get_bd_pins rx_video_clk]
  connect_bd_net -net net_vid_phy_controller_rxoutclk [get_bd_pins vid_phy_controller/rxoutclk] [get_bd_pins vid_phy_rx_axi4s_aclk] [get_bd_pins vid_phy_controller/vid_phy_rx_axi4s_aclk]
  connect_bd_net -net net_vid_phy_controller_tx_tmds_clk_n [get_bd_pins vid_phy_controller/tx_tmds_clk_n] [get_bd_pins HDMI_TX_CLK_N_OUT]
  connect_bd_net -net net_vid_phy_controller_tx_tmds_clk_p [get_bd_pins vid_phy_controller/tx_tmds_clk_p] [get_bd_pins HDMI_TX_CLK_P_OUT]
  connect_bd_net -net net_vid_phy_controller_tx_video_clk [get_bd_pins vid_phy_controller/tx_video_clk] [get_bd_pins tx_video_clk]
  connect_bd_net -net net_vid_phy_controller_txoutclk [get_bd_pins vid_phy_controller/txoutclk] [get_bd_pins vid_phy_tx_axi4s_aclk] [get_bd_pins vid_phy_controller/vid_phy_tx_axi4s_aclk]
  connect_bd_net -net net_zynq_us_ss_0_peripheral_aresetn [get_bd_pins s_axi_cpu_aresetn] [get_bd_pins vid_phy_controller/vid_phy_sb_aresetn] [get_bd_pins vid_phy_controller/vid_phy_axi4lite_aresetn]
  connect_bd_net -net net_zynq_us_ss_0_s_axi_aclk [get_bd_pins s_axi_cpu_aclk] [get_bd_pins vid_phy_controller/vid_phy_sb_aclk] [get_bd_pins vid_phy_controller/vid_phy_axi4lite_aclk] [get_bd_pins vid_phy_controller/drpclk]
...
proc create_hier_cell_hdmi_out { parentCell nameHier } {
  ...
  connect_bd_net -net net_v_hdmi_tx_ss_irq [get_bd_pins frontend/irq] [get_bd_pins irq1]
  ...
  connect_bd_net -net net_zynq_us_ss_0_clk_out2 [get_bd_pins aclk] [get_bd_pins color_convert/ap_clk] [get_bd_pins pixel_unpack/ap_clk] [get_bd_pins frontend/s_axis_video_aclk] [get_bd_pins pixel_reorder/aclk] [get_bd_pins tx_video_axis_reg_slice/aclk]
  connect_bd_net -net net_zynq_us_ss_0_dcm_locked [get_bd_pins aresetn] [get_bd_pins color_convert/ap_rst_n] [get_bd_pins pixel_unpack/ap_rst_n] [get_bd_pins frontend/s_axis_video_aresetn] [get_bd_pins pixel_reorder/aresetn] [get_bd_pins tx_video_axis_reg_slice/aresetn]
...
proc create_hier_cell_hdmi_in { parentCell nameHier } {
  ...
  connect_bd_net -net net_v_hdmi_rx_ss_fid [get_bd_pins frontend/fid] [get_bd_pins fid]
  connect_bd_net -net net_v_hdmi_rx_ss_hpd [get_bd_pins frontend/hpd] [get_bd_pins RX_HPD_OUT]
  connect_bd_net -net net_v_hdmi_rx_ss_irq [get_bd_pins frontend/irq] [get_bd_pins irq]
  ...
  connect_bd_net -net net_zynq_us_ss_0_clk_out2 [get_bd_pins aclk] [get_bd_pins color_convert/ap_clk] [get_bd_pins pixel_pack/ap_clk] [get_bd_pins frontend/s_axis_video_aclk] [get_bd_pins pixel_reorder/aclk] [get_bd_pins rx_video_axis_reg_slice/aclk]
  connect_bd_net -net net_zynq_us_ss_0_dcm_locked [get_bd_pins aresetn] [get_bd_pins color_convert/ap_rst_n] [get_bd_pins pixel_pack/ap_rst_n] [get_bd_pins frontend/s_axis_video_aresetn] [get_bd_pins pixel_reorder/aresetn] [get_bd_pins rx_video_axis_reg_slice/aresetn]
  connect_bd_net -net net_zynq_us_ss_0_peripheral_aresetn [get_bd_pins s_axi_cpu_aresetn] [get_bd_pins frontend/s_axi_cpu_aresetn]
  connect_bd_net -net net_zynq_us_ss_0_s_axi_aclk [get_bd_pins s_axi_cpu_aclk] [get_bd_pins frontend/s_axi_cpu_aclk]
  connect_bd_net -net s_axis_audio_aclk_1 [get_bd_pins s_axis_audio_aclk] [get_bd_pins frontend/s_axis_audio_aclk]
  connect_bd_net -net s_axis_audio_aresetn_1 [get_bd_pins s_axis_audio_aresetn] [get_bd_pins frontend/s_axis_audio_aresetn]
...
proc create_hier_cell_video { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net axi_vdma_0_mm2s_introut [get_bd_pins axi_vdma/mm2s_introut] [get_bd_pins mm2s_introut]
  connect_bd_net -net axi_vdma_0_s2mm_introut [get_bd_pins axi_vdma/s2mm_introut] [get_bd_pins s2mm_introut]
  ...
  connect_bd_net -net net_v_hdmi_rx_ss_hpd [get_bd_pins hdmi_in/RX_HPD_OUT] [get_bd_pins RX_HPD_OUT]
  connect_bd_net -net net_v_hdmi_rx_ss_irq [get_bd_pins hdmi_in/irq] [get_bd_pins irq]
  connect_bd_net -net net_v_hdmi_tx_ss_irq [get_bd_pins hdmi_out/irq1] [get_bd_pins irq1]
  connect_bd_net -net net_vcc_const_dout [get_bd_pins TX_EN_OUT] [get_bd_pins phy/TX_EN_OUT]
  connect_bd_net -net net_vid_phy_controller_irq [get_bd_pins phy/irq2] [get_bd_pins irq2]
  connect_bd_net -net net_vid_phy_controller_phy_txn_out [get_bd_pins phy/HDMI_TX_DAT_N_OUT] [get_bd_pins HDMI_TX_DAT_N_OUT]
  connect_bd_net -net net_vid_phy_controller_phy_txp_out [get_bd_pins phy/HDMI_TX_DAT_P_OUT] [get_bd_pins HDMI_TX_DAT_P_OUT]
  connect_bd_net -net net_vid_phy_controller_rx_tmds_clk_n [get_bd_pins phy/RX_REFCLK_N_OUT] [get_bd_pins RX_REFCLK_N_OUT]
  connect_bd_net -net net_vid_phy_controller_rx_tmds_clk_p [get_bd_pins phy/RX_REFCLK_P_OUT] [get_bd_pins RX_REFCLK_P_OUT]
  connect_bd_net -net net_vid_phy_controller_rx_video_clk [get_bd_pins phy/rx_video_clk] [get_bd_pins hdmi_in/video_clk]
  connect_bd_net -net net_vid_phy_controller_rxoutclk [get_bd_pins phy/vid_phy_rx_axi4s_aclk] [get_bd_pins hdmi_in/link_clk]
  connect_bd_net -net net_vid_phy_controller_tx_tmds_clk_n [get_bd_pins phy/HDMI_TX_CLK_N_OUT] [get_bd_pins HDMI_TX_CLK_N_OUT]
  connect_bd_net -net net_vid_phy_controller_tx_tmds_clk_p [get_bd_pins phy/HDMI_TX_CLK_P_OUT] [get_bd_pins HDMI_TX_CLK_P_OUT]
  connect_bd_net -net net_vid_phy_controller_tx_video_clk [get_bd_pins phy/tx_video_clk] [get_bd_pins hdmi_out/video_clk]
  connect_bd_net -net net_vid_phy_controller_txoutclk [get_bd_pins phy/vid_phy_tx_axi4s_aclk] [get_bd_pins hdmi_out/link_clk]
  connect_bd_net -net net_zynq_us_ss_0_clk_out2 [get_bd_pins aclk] [get_bd_pins hdmi_in/aclk] [get_bd_pins hdmi_out/aclk] [get_bd_pins axi_vdma/m_axi_mm2s_aclk] [get_bd_pins axi_vdma/m_axis_mm2s_aclk] [get_bd_pins axi_vdma/m_axi_s2mm_aclk] [get_bd_pins axi_vdma/s_axis_s2mm_aclk]
  ...
  connect_bd_net -net net_zynq_us_ss_0_peripheral_aresetn [get_bd_pins s_axi_cpu_aresetn] [get_bd_pins hdmi_in/s_axi_cpu_aresetn] [get_bd_pins hdmi_out/s_axi_cpu_aresetn] [get_bd_pins phy/s_axi_cpu_aresetn] [get_bd_pins axi_vdma/axi_resetn]
  connect_bd_net -net net_zynq_us_ss_0_s_axi_aclk [get_bd_pins s_axi_cpu_aclk] [get_bd_pins hdmi_in/s_axi_cpu_aclk] [get_bd_pins hdmi_out/s_axi_cpu_aclk] [get_bd_pins phy/s_axi_cpu_aclk] [get_bd_pins axi_vdma/s_axi_lite_aclk]
...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.NUM_MI {19} $axi_interconnect
  ...
  set_property CONFIG.C_MB_DBG_PORTS {2} $mdm
...
\
  ...
  set_property CONFIG.C_ALL_OUTPUTS {1} $reset_control
  ...
  set_property CONFIG.NUM_PORTS {9} $xlconcat0
  ...
  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins proc_sys_reset_1/interconnect_aresetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon_1/ARESETN]
  ...
  connect_bd_net -net data_i_1 [get_bd_pins pmod0_buf/IOBUF_IO_O] [get_bd_pins iop_pmod0/data_i]
  connect_bd_net -net data_i_2 [get_bd_pins pmod1_buf/IOBUF_IO_O] [get_bd_pins iop_pmod1/data_i]
  ...
  connect_bd_net -net mb_pmod1_intr_ack_Dout [get_bd_pins mb_iop_pmod1_intr_ack/Dout] [get_bd_pins iop_pmod1/intr_ack]
  connect_bd_net -net mb_pmod1_reset_Dout [get_bd_pins mb_iop_pmod1_reset/Dout] [get_bd_pins iop_pmod1/aux_reset_in]
  connect_bd_net -net mdm_0_Debug_SYS_Rst [get_bd_pins mdm/Debug_SYS_Rst] [get_bd_pins iop_pmod0/mb_debug_sys_rst] [get_bd_pins iop_pmod1/mb_debug_sys_rst]
  ...
  connect_bd_net -net net_rst_processor_1_100M_interconnect_aresetn [get_bd_pins proc_sys_reset_0/interconnect_aresetn] [get_bd_pins axi_interconnect/ARESETN] [get_bd_pins axi_interconnect_0/ARESETN]
  connect_bd_net -net net_v_hdmi_rx_ss_hpd [get_bd_pins video/RX_HPD_OUT] [get_bd_ports RX_HPD_OUT]
  ...
  connect_bd_net -net net_vcc_const_dout [get_bd_pins vcc_const/dout] [get_bd_ports TX_EN_OUT] [get_bd_pins video/TX_EN_OUT]
  connect_bd_net -net net_vid_phy_controller_irq [get_bd_pins video/irq2] [get_bd_pins xlconcat0/In0]
  connect_bd_net -net net_vid_phy_controller_phy_txn_out [get_bd_pins video/HDMI_TX_DAT_N_OUT] [get_bd_ports HDMI_TX_DAT_N_OUT]
  connect_bd_net -net net_vid_phy_controller_phy_txp_out [get_bd_pins video/HDMI_TX_DAT_P_OUT] [get_bd_ports HDMI_TX_DAT_P_OUT]
  connect_bd_net -net net_vid_phy_controller_rx_tmds_clk_n [get_bd_pins video/RX_REFCLK_N_OUT] [get_bd_ports RX_REFCLK_N_OUT]
  connect_bd_net -net net_vid_phy_controller_rx_tmds_clk_p [get_bd_pins video/RX_REFCLK_P_OUT] [get_bd_ports RX_REFCLK_P_OUT]
  connect_bd_net -net net_vid_phy_controller_tx_tmds_clk_n [get_bd_pins video/HDMI_TX_CLK_N_OUT] [get_bd_ports HDMI_TX_CLK_N_OUT]
  connect_bd_net -net net_vid_phy_controller_tx_tmds_clk_p [get_bd_pins video/HDMI_TX_CLK_P_OUT] [get_bd_ports HDMI_TX_CLK_P_OUT]
  connect_bd_net -net net_zynq_us_pl_resetn0 [get_bd_pins ps_e_0/pl_resetn0] [get_bd_pins proc_sys_reset_0/aux_reset_in] [get_bd_pins proc_sys_reset_0/dcm_locked] [get_bd_pins proc_sys_reset_1/aux_reset_in] [get_bd_pins proc_sys_reset_1/dcm_locked] [get_bd_pins proc_sys_reset_2/aux_reset_in] [get_bd_pins proc_sys_reset_2/dcm_locked] [get_bd_pins proc_sys_reset_3/aux_reset_in] [get_bd_pins proc_sys_reset_3/dcm_locked]
  connect_bd_net -net net_zynq_us_ss_0_clk_out2 [get_bd_pins ps_e_0/pl_clk1] [get_bd_pins video/aclk] [get_bd_pins axi_interconnect/M07_ACLK] [get_bd_pins axi_interconnect/M08_ACLK] [get_bd_pins axi_interconnect/M09_ACLK] [get_bd_pins axi_interconnect/M10_ACLK] [get_bd_pins axi_interconnect/M16_ACLK] [get_bd_pins axi_interconnect/M18_ACLK] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon_1/ACLK] [get_bd_pins axi_mem_intercon_1/S00_ACLK] [get_bd_pins axi_mem_intercon_1/M00_ACLK] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins ps_e_0/saxihp0_fpd_aclk] [get_bd_pins ps_e_0/saxihp2_fpd_aclk] [get_bd_pins shutdown_HP0_FPD/clk] [get_bd_pins shutdown_HP2_FPD/clk]
  connect_bd_net -net net_zynq_us_ss_0_dcm_locked [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins video/aresetn] [get_bd_pins axi_interconnect/M07_ARESETN] [get_bd_pins axi_interconnect/M08_ARESETN] [get_bd_pins axi_interconnect/M09_ARESETN] [get_bd_pins axi_interconnect/M10_ARESETN] [get_bd_pins axi_interconnect/M16_ARESETN] [get_bd_pins axi_interconnect/M18_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins shutdown_HP0_FPD/resetn] [get_bd_pins shutdown_HP2_FPD/resetn]
  connect_bd_net -net net_zynq_us_ss_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins iop_pmod0/s_axi_aresetn] [get_bd_pins iop_pmod1/s_axi_aresetn] [get_bd_pins video/s_axi_cpu_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect/S00_ARESETN] [get_bd_pins axi_interconnect/M00_ARESETN] [get_bd_pins axi_interconnect/M01_ARESETN] [get_bd_pins axi_interconnect/M02_ARESETN] [get_bd_pins axi_interconnect/M03_ARESETN] [get_bd_pins axi_interconnect/M04_ARESETN] [get_bd_pins axi_interconnect/M05_ARESETN] [get_bd_pins axi_interconnect/M06_ARESETN] [get_bd_pins axi_interconnect/M11_ARESETN] [get_bd_pins axi_interconnect/M12_ARESETN] [get_bd_pins axi_interconnect/M13_ARESETN] [get_bd_pins axi_interconnect/M14_ARESETN] [get_bd_pins axi_interconnect/M15_ARESETN] [get_bd_pins axi_interconnect/M17_ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins fmch_axi_iic/s_axi_aresetn] [get_bd_pins gpio_btns/s_axi_aresetn] [get_bd_pins gpio_leds/s_axi_aresetn] [get_bd_pins gpio_sws/s_axi_aresetn] [get_bd_pins reset_control/s_axi_aresetn]
  connect_bd_net -net net_zynq_us_ss_0_s_axi_aclk [get_bd_pins ps_e_0/pl_clk0] [get_bd_pins address_remap_0/m_axi_out_aclk] [get_bd_pins address_remap_0/s_axi_in_aclk] [get_bd_pins iop_pmod0/clk_100M] [get_bd_pins iop_pmod1/clk_100M] [get_bd_pins video/s_axi_cpu_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect/ACLK] [get_bd_pins axi_interconnect/S00_ACLK] [get_bd_pins axi_interconnect/M00_ACLK] [get_bd_pins axi_interconnect/M01_ACLK] [get_bd_pins axi_interconnect/M02_ACLK] [get_bd_pins axi_interconnect/M03_ACLK] [get_bd_pins axi_interconnect/M04_ACLK] [get_bd_pins axi_interconnect/M05_ACLK] [get_bd_pins axi_interconnect/M06_ACLK] [get_bd_pins axi_interconnect/M11_ACLK] [get_bd_pins axi_interconnect/M12_ACLK] [get_bd_pins axi_interconnect/M13_ACLK] [get_bd_pins axi_interconnect/M14_ACLK] [get_bd_pins axi_interconnect/M15_ACLK] [get_bd_pins axi_interconnect/M17_ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins fmch_axi_iic/s_axi_aclk] [get_bd_pins gpio_btns/s_axi_aclk] [get_bd_pins gpio_leds/s_axi_aclk] [get_bd_pins gpio_sws/s_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins ps_e_0/saxi_lpd_aclk] [get_bd_pins reset_control/s_axi_aclk] [get_bd_pins shutdown_LPD/clk]
  ...
  connect_bd_net -net pmod0_intr_req_Dout [get_bd_pins mb_iop_pmod0_intr_ack/Dout] [get_bd_pins iop_pmod0/intr_ack]
  connect_bd_net -net pmod0_peripheral_aresetn [get_bd_pins iop_pmod0/peripheral_aresetn] [get_bd_pins axi_interconnect_0/S00_ARESETN]
  connect_bd_net -net pmod0_reset_Dout [get_bd_pins mb_iop_pmod0_reset/Dout] [get_bd_pins iop_pmod0/aux_reset_in]
  ...
  connect_bd_net -net pmod1_peripheral_aresetn [get_bd_pins iop_pmod1/peripheral_aresetn] [get_bd_pins address_remap_0/m_axi_out_aresetn] [get_bd_pins address_remap_0/s_axi_in_aresetn] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins shutdown_LPD/resetn]
  connect_bd_net -net pmod1_tri_o [get_bd_pins iop_pmod1/tri_o] [get_bd_pins pmod1_buf/IOBUF_IO_T]
  connect_bd_net -net xlconcat0_dout [get_bd_pins xlconcat0/dout] [get_bd_pins axi_intc_0/intr]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins ps_e_0/pl_ps_irq0]
  connect_bd_net -net xlconcat_1_dout [get_bd_pins xlconcat_1/dout] [get_bd_pins ps_e_0/pl_ps_irq1]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins xlslice_0/Dout] [get_bd_ports IDT_8T49N241_RST_OUT]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins xlslice_1/Dout] [get_bd_ports HDMI_RX_LS_OE]
  connect_bd_net -net zynq_us_emio_gpio_o [get_bd_pins ps_e_0/emio_gpio_o] [get_bd_pins mb_iop_pmod0_intr_ack/Din] [get_bd_pins mb_iop_pmod0_reset/Din] [get_bd_pins mb_iop_pmod1_intr_ack/Din] [get_bd_pins mb_iop_pmod1_reset/Din]
  connect_bd_net -net zynq_us_pl_clk2 [get_bd_pins ps_e_0/pl_clk2] [get_bd_pins proc_sys_reset_2/slowest_sync_clk]
  connect_bd_net -net zynq_us_pl_clk3 [get_bd_pins ps_e_0/pl_clk3] [get_bd_pins proc_sys_reset_3/slowest_sync_clk]
  ...
  assign_bd_address -offset 0x80050000 -range 0x00010000 -with_name SEG_color_convert_Reg_1 -target_address_space [get_bd_addr_spaces ps_e_0/Data] [get_bd_addr_segs video/hdmi_in/color_convert/s_axi_control/Reg] -force
  ...
  assign_bd_address -offset 0x80020000 -range 0x00020000 -with_name SEG_frontend_Reg_1 -target_address_space [get_bd_addr_spaces ps_e_0/Data] [get_bd_addr_segs video/hdmi_out/frontend/S_AXI_CPU_IN/Reg] -force
  ...
  assign_bd_address -offset 0x800B0000 -range 0x00010000 -with_name SEG_mb_bram_ctrl_Mem0_1 -target_address_space [get_bd_addr_spaces ps_e_0/Data] [get_bd_addr_segs iop_pmod1/mb_bram_ctrl/S_AXI/Mem0] -force
  ...
  set_property PFM.AXI_PORT {  M_AXI_HPM0_FPD {memport "M_AXI_GP"}  M_AXI_HPM1_FPD {memport "M_AXI_GP"}  S_AXI_HPC0_FPD {memport "S_AXI_HPC"}  S_AXI_HPC1_FPD {memport "S_AXI_HPC"}  S_AXI_HP1_FPD {memport "S_AXI_HP"}  S_AXI_HP3_FPD {memport "S_AXI_HP"}  } [get_bd_cells /ps_e_0]
