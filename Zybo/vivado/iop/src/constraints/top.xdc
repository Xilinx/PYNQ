...
set_property PULLUP true [get_ports {pmodJD[2]}]
set_property PULLUP true [get_ports {pmodJD[3]}]
set_property PULLUP true [get_ports {pmodJD[6]}]
set_property PULLUP true [get_ports {pmodJD[7]}]
...
set_property PULLUP true [get_ports {pmodJE[2]}]
set_property PULLUP true [get_ports {pmodJE[3]}]
set_property PULLUP true [get_ports {pmodJE[6]}]
set_property PULLUP true [get_ports {pmodJE[7]}]
