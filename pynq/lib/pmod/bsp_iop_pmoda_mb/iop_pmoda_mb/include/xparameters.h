...
#define XPAR_IOP_PMODA_MB_COMPONENT_NAME system_mb_1
...
#define XPAR_MICROBLAZE_COMPONENT_NAME system_mb_1
...
#define XPAR_IOP_PMODA_INTC_IVAR_RESET_VALUE 0x00000010
