proc create_ipi_design { offsetfile design_name } {
	...
	set offset_file "${bd_path}/arduino_io_switch_v1_0_tb_include.vh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef arduino_io_switch_v1_0_tb_include_vh_"
	puts $fp "`define arduino_io_switch_v1_0_tb_include_vh_\n"
...
set test_bench_file ${ip_path}/example_designs/bfm_design/arduino_io_switch_v1_0_tb.v
...
for { set i 1 } { 1 } { incr i } {
	set design_name "arduino_io_switch_v1_0_bfm_${i}"
...
remove_files -quiet -fileset sim_1 arduino_io_switch_v1_0_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top arduino_io_switch_v1_0_tb [get_filesets sim_1]
