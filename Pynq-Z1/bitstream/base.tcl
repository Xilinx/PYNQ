...
set_property -dict [list CONFIG.PCW_UIPARAM_DDR_PARTNO {Custom}] [get_bd_cells processing_system7_0]

set_property -dict [list CONFIG.PCW_UIPARAM_DDR_BANK_ADDR_COUNT {3} CONFIG.PCW_UIPARAM_DDR_ROW_ADDR_COUNT {15} CONFIG.PCW_UIPARAM_DDR_COL_ADDR_COUNT {10} CONFIG.PCW_UIPARAM_DDR_CL {7} CONFIG.PCW_UIPARAM_DDR_CWL {6} CONFIG.PCW_UIPARAM_DDR_T_RCD {13.125} CONFIG.PCW_UIPARAM_DDR_T_RP {13.125} CONFIG.PCW_UIPARAM_DDR_T_RC {50.625} CONFIG.PCW_UIPARAM_DDR_T_RAS_MIN {35} CONFIG.PCW_UIPARAM_DDR_T_FAW {40} CONFIG.PCW_UIPARAM_DDR_DRAM_WIDTH {16 Bits} CONFIG.PCW_UIPARAM_DDR_DEVICE_CAPACITY {4096 MBits} CONFIG.PCW_UIPARAM_DDR_SPEED_BIN {DDR3_1066F}] [get_bd_cells processing_system7_0]
